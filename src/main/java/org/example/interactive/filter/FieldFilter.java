...
/**
 * The FieldFilter class filters a given list of entries by the field column and low/high range values.
 *
 * DESIGN TRACEABILITY: Subset/Extension of Section 4.2.7
 */
public class FieldFilter implements ILogFilter {
    public JSONArray filter(JSONArray entries, Object rangeLow, Object rangeHigh) throws JSONException {
        ...
        // Cast the range objects to a String because field is a String
        ...
        for(int i = 0; i < entries.length(); i++) {
            ...
            // Check if field within range, and add entry to filteredEntries
            String component = entry.getString("field");
